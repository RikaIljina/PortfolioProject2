...
![Lighthouse report on mobile devices showing values over 97](assets/readme_files/readme_lighthouse_mobile.png)

Desktop:

![Lighthouse report on mobile devices showing values over 99](assets/readme_files/readme_lighthouse_desktop.png)

### Wave

The website passed the [WAVE report](https://wave.webaim.org/):

<img src="assets/readme_files/readme_wave_test.png" alt="Wave accessibility test results showing no errors" width="300">
