...
Balanced scales are displayed on the end game screen in case of a draw.
...
- [ ] Add graphics for each category and on the loading screen to make them look more interesting
